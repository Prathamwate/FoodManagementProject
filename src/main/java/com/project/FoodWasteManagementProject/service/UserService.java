...
public class UserService {
  ...
  public ResponseEntity<String> addUser(String user) {
    ...
    if (jsonArray.isEmpty()) {
      ...
      return new ResponseEntity<>(jsonArray.toString(), HttpStatus.BAD_REQUEST);
    }
  }
  ...
  public ResponseEntity<String> getNgoByCity(String cityName, Integer pincode) {
    ...
    if (cityName != null) {
      try {
        ...
        return new ResponseEntity<>("Ngos not Found", HttpStatus.BAD_REQUEST);
      }
    } else {
      try {
